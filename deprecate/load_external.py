...
AUTO = tf.data.experimental.AUTOTUNE # <class 'int'>
#超参数定义
...
if len(EXTERNAL_FILENAMES) == 0:
    print('Error to load external data, please check path name.')
...
dataset = get_training_dataset(external=True)
v = get_validation_dataset()
t = get_test_dataset()
print('OK!')